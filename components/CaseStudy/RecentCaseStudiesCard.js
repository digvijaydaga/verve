          ...
          <div className="row justify-content-center">
            ...
            >
              <div className="single-projects-box">
                ...
                <div className="projects-content">
                  <h3>
                    <Link href="/case-study-details">Business Consulting</Link>
                  </h3>
                  <p>
            ...
            >
              <div className="single-projects-box">
                ...
                <div className="projects-content">
                  <h3>
                    <Link href="/case-study-details">SEO Optimization</Link>
                  </h3>
                  <p>
                    Best Strategic planning dolor sit amet consectetur
                    adipiscing elit. Scelerisque amet odio velit eu auctor.
            ...
            >
              <div className="single-projects-box">
                ...
                <div className="projects-content">
                  <h3>
                    <Link href="/case-study-details">Advanced Analytics</Link>
                  </h3>
                  <p>
                    Best Strategic planning dolor sit amet consectetur
                    adipiscing elit. Scelerisque amet odio velit eu auctor.
            ...
            >
              <div className="single-projects-box">
                ...
                <div className="projects-content">
                  <h3>
                    <Link href="/case-study-details">Email Marketing</Link>
                  </h3>
                  <p>
                    Best Strategic planning dolor sit amet consectetur
                    adipiscing elit. Scelerisque amet odio velit eu auctor.
