    ...
    <>
	 {/* Top Header */}
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="sidebar-content">
                <h3>About Us</h3>
                <p>
                   We have been at the forefront of the digital landscape, adapting to the ever-evolving technological advancements. Our journey has been shaped by a passionate team of developers, designers, and strategists who share a common goal – to transform your digital vision into reality.
                </p>
      ...
      <style jsx>{`
        ...
        .navbar-box-style .main-navbar .navbar .navbar-nav .nav-item .nav-link {
          color: var(--paragraph-color);
        }
        .navbar-box-style
          .main-navbar
