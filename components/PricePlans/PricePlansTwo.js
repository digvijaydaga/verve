...
const PricePlansTwo = () => {
  return (
    <>
      <div className="plans-area bg-gradient-color pt-100 pb-70">
        <div className="container">
          <div className="section-title">
            <h2>Choose Your Best Plans</h2>
            <p>
              Pay by monthly or yearly, you can cancel it anytime whatever you
              want
            </p>
          </div>
                ...
                <div className="row justify-content-center">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-plans-table active-box">
                      ...
                      <ul className="plans-features-list">
                        <li>
                          <i className="ri-check-line"></i> Up to 15 Website
                        </li>
                        <li>
                          <i className="ri-check-line"></i> Lifetime Free
                          Support
                        ...
                        <li>
                          <i className="ri-check-line"></i> 15 GB Dedicated
                          Hosting Free
                        </li>
                        <li>
                          <i className="ri-check-line"></i> 24/7 Hours Support
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-plans-table">
                      ...
                      <ul className="plans-features-list">
                        <li>
                          <i className="ri-check-line"></i> Up to 20 Website
                        </li>
                        <li>
                          <i className="ri-check-line"></i> Lifetime Free
                          Support
                        ...
                        <li>
                          <i className="ri-check-line"></i> 20 GB Dedicated
                          Hosting Free
                        </li>
                        <li>
                          <i className="ri-check-line"></i> 24/7 Hours Support
                ...
                <div className="row justify-content-center">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-plans-table active-box">
                      ...
                      <ul className="plans-features-list">
                        <li>
                          <i className="ri-check-line"></i> Up to 25 Website
                        </li>
                        <li>
                          <i className="ri-check-line"></i> Lifetime Free
                          Support
                        ...
                        <li>
                          <i className="ri-check-line"></i> 25 GB Dedicated
                          Hosting Free
                        </li>
                        <li>
                          <i className="ri-check-line"></i> 24/7 Hours Support
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-plans-table">
                      ...
                      <ul className="plans-features-list">
                        <li>
                          <i className="ri-check-line"></i> Up to 30 Website
                        </li>
                        <li>
                          <i className="ri-check-line"></i> Lifetime Free
                          Support
                        ...
                        <li>
                          <i className="ri-check-line"></i> 30 GB Dedicated
                          Hosting Free
                        </li>
                        <li>
                          <i className="ri-check-line"></i> 24/7 Hours Support
      ...
      <style jsx>{`
        ...
        .plans-shape-1 {
          ...
          top: 40%;
          left: 60%;
          -webkit-transform: translateY(-40%) translateX(-60%);
        ...
        .plans-shape-2 {
          ...
          top: 45%;
          left: 58%;
          -webkit-transform: translateY(-45%) translateX(-58%);
          transform: translateY(-45%) translateX(-58%);
        }
        .plans-shape-3 {
          position: absolute;
          bottom: 22%;
