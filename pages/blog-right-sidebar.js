                ...
                <div className="col-lg-6 col-md-6">
                  <div className="single-blog">
                    ...
                    <div className="blog-content">
                      ...
                      <h3>
                        <Link href="/blog-details">
                          <span>Branding Involves Developing a Strategy to Creating a
                          Point of Differentiation.</span>
                        </Link>
                      </h3>
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="single-blog">
                    ...
                    <div className="blog-content">
                      ...
                      <h3>
                        <Link href="/blog-details">
                        <span>Design is a Plan or Specification For The Construction
                          of an Object.</span>
                        </Link>
                      </h3>
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="single-blog">
                    ...
                    <div className="blog-content">
                      ...
                      <h3>
                        <Link href="/blog-details">
                        <span>Branding Involves Developing the Strategy to Create a
                          Point.</span>
                        </Link>
                      </h3>
