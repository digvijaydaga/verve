    ...
    <>
      ...
      <>
              ...
              <div className="col-lg-6">
                <div className="single-cases">
                  ...
                  <div className="cases-content">
                    ...
                    <h3>
                      <Link href="/case-study-details">
                        <span>Product Branding and Web Development</span>
                      </Link>
                    </h3>
                    <p>
                      Branding just like your personal identity makes you
                      uniquely you, your brand identity is the special sauce of
                      your business that sets you apart from every other Tom,
                      Dick, and Harry, Inc. Branding just like your personal
                      identity makes you uniquely.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6">
                <div className="single-cases">
                  ...
                  <div className="cases-content">
                    ...
                    <h3>
                      <Link href="/case-study-details">
                        <span>Brand Identity and Mockup</span>
                      </Link>
                    </h3>
                    <p>
                      Branding just like your personal identity makes you
              ...
              <div className="col-lg-6">
                <div className="single-cases">
                  ...
                  <div className="cases-content">
                    ...
                    <h3>
                      <Link href="/case-study-details">
                        <span>Banking Mobile iOS App Design</span>
                      </Link>
                    </h3>
                    <p>
                      Branding just like your personal identity makes you
              ...
              <div className="col-lg-6">
                <div className="single-cases">
                  ...
                  <div className="cases-content">
                    <div className="tags">
                      <Link href="/case-study-details">
                        <span>UI/IX Design</span>
                      </Link>
                    </div>

                    <h3>
                      <Link href="/case-study-details">
                        <span>Ozen Website Design and Development</span>
                      </Link>
                    </h3>
                    <p>
                      Branding just like your personal identity makes you
                      uniquely you, your brand identity is the special sauce of
                      your business that sets.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6">
                <div className="single-cases">
                  ...
                  <div className="cases-content">
                    ...
                    <h3>
                      <Link href="/case-study-details">
                        <span>Design and Development for Medical</span>
                      </Link>
                    </h3>
                    <p>
                      Branding just like your personal identity makes you
        ...
        <style jsx>{`
          ...
          .single-cases .cases-content .tags span {
          ...
          .single-cases .cases-content .tags span:hover {
          ...
          .single-cases .cases-content h3 span {
            position: relative;
          }
          .single-cases .cases-content h3 span::before {
            content: "";
            position: absolute;
            width: 0%;
            height: 100%;
          ...
          .single-cases:hover .cases-content h3 span {
            color: var(--main-color);
          }
          .single-cases:hover .cases-content h3 span::before {
            width: 100%;
          }
